  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-black px-8 py-4 rounded-lg font-semibold text-lg hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105 shadow-lg">
              Explore Collection
            </button>
      ...
      <div className="absolute top-20 right-10 hidden lg:block">
        <div className="w-4 h-4 bg-yellow-400 rounded-full opacity-60 animate-pulse"></div>
      </div>
      <div className="absolute top-1/2 right-1/4 hidden lg:block">
        <div className="w-2 h-2 bg-yellow-500 rounded-full opacity-80 animate-pulse animation-delay-300"></div>
      </div>
      <div className="absolute bottom-1/4 right-12 hidden lg:block">
        <div className="w-3 h-3 bg-yellow-300 rounded-full opacity-70 animate-pulse animation-delay-700"></div>
      </div>
