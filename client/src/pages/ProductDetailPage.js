            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="text-sm bg-gray-100 hover:bg-yellow-100 text-gray-700 hover:text-yellow-700 px-3 py-1 rounded-lg transition-colors duration-200 disabled:opacity-50"
                >
                  {isRegenerating ? 'Regenerating...' : '✨ AI Enhance'}
                </button>
              </div>
